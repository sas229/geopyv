...
quantity = np.abs(2*node_strains[:,2]*100) # Percentage strains.
...
# contours = ax.tripcolor(triangulation, quantity, alpha=0.75, vmin=0, vmax=10)
contours = ax.tripcolor(triangulation, quantity, alpha=0.75, vmin=0, vmax=10, shading='gouraud')
