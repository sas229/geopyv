...
class ValidationBase(Object):
    ...
    def unity_kde(
        ...
        *,
        ...
        Method to plot observed and applied warps.
        ...
        self._report(
            gp.check._check_index(
                ...
                "component",
                1,
                self._fields[0].data["particles"][0][quantity],
            ),
            "IndexError",
        )
        ...
        log.info("Plotting unity error...")

        fig, ax = gp.plots.unity_kde(
            data=self.data,
            quantity=quantity,
            component=component,
            xlim=xlim,
    ...
    def standarderror(
        ...
        *,
        ...
        fig, ax = gp.plots.standarderror_validation(
            data=self.data,
            component=component,
            position=position,
            xlim=xlim,
    ...
    def unity_validation(
        ...
        *,
        ...
        fig, ax = gp.plots.unity_validation(
            data=self.data,
            quantity=quantity,
            component=component,
            zeroed=zeroed,
